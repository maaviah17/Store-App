        ...
        <div className="w-[600px]">
                 <div className="modal-box">
                    ...
                    <div className="mt-4 space-y-2">
                            <span>Name</span>
                            <br />
                            <input type="text" placeholder="Enter your name" className="w-80 px-3 border rounded-md outline-none" {...register("name", { required: true })}></input>
                            <br />
                    ...
                    <div className="mt-4 space-y-2">
                        ...
                        <div className="flex justify-around mt-4">
                            ...
                            <p className="text-lg">Have an account? {" "}<button onClick={()=>
                                                        document.getElementById("my_modal_3").showModal()}
                                 to={"/"} className="underline text-blue-500 cursor-pointer">Login</button>
                                 <Login />
                                 </p>
                        </div>
                        </form>
